...
export default function HeroGridRepeater({ block, mediaHandler }) {
  ...
  return (
    ...
    //                 ? "top-[31%] 2sm:top-[34%] sm:top-[32%] md:top-[23%] lg:top-[18%] xl:top-[20%] xxl:top-[22%]"
    //                 : "top-[45%] md:top-[30%]"
    //             } translate-y-[-50%] left-0 px-[10px] lg:px-5 z-[20] cursor-pointer`}
    ...
    //                 ? "top-[31%] 2sm:top-[34%] sm:top-[32%] md:top-[23%] lg:top-[18%] xl:top-[20%] xxl:top-[22%]"
    //                 : "top-[45%] md:top-[30%]"
    //             } translate-y-[-50%] right-0 px-[10px] lg:px-5 z-[20] cursor-pointer`}
